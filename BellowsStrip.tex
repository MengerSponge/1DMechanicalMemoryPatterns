...
\usepackage[paperheight=30cm, paperwidth=50cm, margin = 0cm, top = .5cm]{geometry}
\usepackage{graphicx}
\usepackage{tikz}
...
\begin{scope}[yshift=\pgfmathresult cm,rotate=90]
...
\foreach \phioneA/\phioneB in {75/75, 77/77, 79/79, 81/81}{
